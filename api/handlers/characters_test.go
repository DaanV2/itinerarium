...
func newCharactersTestEnv(t *testing.T) charactersTestEnv {
	...
	router := transport.NewRouter(
		transport.WithHandle("GET /api/characters", requireAuth(handlers.ListCharactersHandler(characterSvc))),
		transport.WithHandle("POST /api/characters", requireAuth(handlers.CreateCharacterHandler(characterSvc))),
		transport.WithHandle("GET /api/characters/{id}", requireAuth(handlers.GetCharacterHandler(characterSvc))),
		transport.WithHandle(
			"PATCH /api/characters/{id}", requireAuth(handlers.UpdateCharacterHandler(characterSvc)),
		),
	)
