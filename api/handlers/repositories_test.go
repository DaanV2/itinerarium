...
func newRepositoriesTestEnv(t *testing.T) repositoriesTestEnv {
	...
	router := transport.NewRouter(
		transport.WithHandle("GET /api/repositories", requireAuth(handlers.ListRepositoriesHandler(repoSvc))),
		transport.WithHandle("GET /api/repositories/{id}", requireAuth(handlers.GetRepositoryHandler(repoSvc))),
	)
